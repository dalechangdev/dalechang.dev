      ...
      <main className={styles.hero}>
        <div className={styles.heroContent}>
          <p className={styles.heroLabel}>
            <span className={styles.rupeeGem} aria-hidden="true" />
        ...
        <div className={styles.heroVisual}>
          ...
          <div className={styles.floatingCard}>
            <span className={`${styles.rupeeGem} ${styles.rupeeGemGreen}`} aria-hidden="true" />
            <span>Shipped 12+ products</span>
          </div>
          <div className={styles.floatingCard} style={{ animationDelay: "0.5s" }}>
            <span className={`${styles.rupeeGem} ${styles.rupeeGemBlue}`} aria-hidden="true" />
            <span>Product-first thinking</span>
          </div>
          <div className={styles.floatingCard} style={{ animationDelay: "1s" }}>
            <span className={`${styles.rupeeGem} ${styles.rupeeGemGold}`} aria-hidden="true" />
